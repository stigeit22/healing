...
import 'component/botomoption.dart';
import 'component/form_signup.dart';
                    ...
                    Row(
                      ...
                      children: [
                        Text("Sudah Memiliki Akun?",
                            ...
                            TextButton(onPressed: (){Get.toNamed("Login");}, child: Text("Masuk",style: TextStyle(color: Color(0xff5C40CC)),))
                      ],
                    ),
