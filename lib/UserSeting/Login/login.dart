      ...
      child: ListView(
        children: [Column(
         ...
         SizedBox(
            ...
            child: TextButton(onPressed: (){Get.toNamed("buttomNavigator");}, child: Text("Masuk", style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: Colors.white),)),
          ),
                  ...
                  Row(
                    ...
                    children: [
                      Text("Belum Memiliki Akun?",
                          ...
                          TextButton(onPressed: (){Get.toNamed("signUp");}, child: Text("Daftar",style: TextStyle(color: Color(0xff5C40CC)),))
                    ],
                  ),
